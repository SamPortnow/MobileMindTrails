...
jsPsych.plugins["button-response-wait"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function end_trial() {
      ...
      console.log(trial_data.key_answer);
      console.log(trial_data.button_pressed);
      if (trial_data.key_answer == response.button)
      {
